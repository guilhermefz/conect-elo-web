...
export function ToastSucesso({ mensagem }: Props) {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-surface border border-emerald-500 text-white px-5 py-4 rounded-xl shadow-2xl min-w-72">
